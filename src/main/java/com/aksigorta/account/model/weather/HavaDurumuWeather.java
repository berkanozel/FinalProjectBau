...
public class HavaDurumuWeather {
	private String date;
	private List<HavaDurumuWeatherAstronomy> astronomy;
	...
	private List<HavaDurumuWeatherHourly> hourly;
	...
	public List<HavaDurumuWeatherAstronomy> getAstronomy() {
		return astronomy;
	}
	public void setAstronomy(List<HavaDurumuWeatherAstronomy> astronomy) {
	...
	public List<HavaDurumuWeatherHourly> getHourly() {
		return hourly;
	}
	public void setHourly(List<HavaDurumuWeatherHourly> hourly) {
		this.hourly = hourly;
	}
}
